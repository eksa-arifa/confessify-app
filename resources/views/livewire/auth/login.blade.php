...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('home') }}">
            <img src="{{url(asset('icon.ico'))}}" alt="icon" width="80" class="mx-auto">
        </a>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            ...
            <p class="text-center my-8">Other options sign in</p>
            <a href="{{route('oauth.google')}}" class="block mx-auto w-fit text-indigo-600">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/768px-Google_%22G%22_logo.svg.png" alt="google" width="30">
            </a>
        </div>
    </div>
</div>
